...
export default function NinthSection() {
  ...
  return (
    <section className="relative flex flex-col pt-8 pb-6 px-8 z-10 w-full bg-[#791220] text-[#f4efe6] h-screen font-sans overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto w-full px-24 flex flex-col h-full z-10 relative">
        ...
        {/* Logos Container */}
        <div className="flex w-full mb-auto mt-2">
          {/* Grid */}
